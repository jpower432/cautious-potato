...
x-trestle-set-params:
  ...
  sa-11_odp.02:
    guidelines:
      - prose: frequency at which to conduct <SA-11_ODP[01] SELECTED PARAMETER VALUE(S)>
          testing/evaluation is defined;
    alt-identifier: sa-11_prm_2
    profile-values:
    profile-param-value-origin: <REPLACE_ME>
  sa-11_odp.03:
    guidelines:
      - prose: depth and coverage of <SA-11_ODP[01] SELECTED PARAMETER VALUE(S)> testing/evaluation
          is defined;
