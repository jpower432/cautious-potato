...
x-trestle-set-params:
  ...
  sa-15_odp.01:
    guidelines:
      - prose: frequency at which to review the development process, standards, tools,
          tool options, and tool configurations is defined;
    alt-identifier: sa-15_prm_1
    profile-values:
    profile-param-value-origin: <REPLACE_ME>
  sa-15_odp.02:
    guidelines:
      - prose: security requirements to be satisfied by the process, standards, tools,
          tool options, and tool configurations are defined;
    profile-values:
    profile-param-value-origin: <REPLACE_ME>
  sa-15_odp.03:
    profile-values:
