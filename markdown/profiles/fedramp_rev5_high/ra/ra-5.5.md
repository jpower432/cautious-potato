...
x-trestle-set-params:
  ...
  ra-05.05_odp.01:
    guidelines:
      - prose: system components to which privileged access is authorized for selected
          vulnerability scanning activities are defined;
    alt-identifier: ra-5.5_prm_1
    profile-values:
    profile-param-value-origin: <REPLACE_ME>
  ra-05.05_odp.02:
    guidelines:
      - prose: vulnerability scanning activities selected for privileged access authorization
          to system components are defined;
