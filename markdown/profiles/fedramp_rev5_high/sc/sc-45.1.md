...
x-trestle-set-params:
  ...
  sc-45.01_odp.01:
    guidelines:
      - prose: the frequency at which to compare the internal system clocks with the
  ...
  sc-45.01_odp.02:
    guidelines:
      - prose: the authoritative time source to which internal system clocks are to
          be compared is defined;
    alt-identifier: sc-45.1_prm_2
    profile-values:
    profile-param-value-origin: <REPLACE_ME>
  sc-45.01_odp.03:
    guidelines:
      - prose: the time period to compare the internal system clocks with the authoritative
          time source is defined;
