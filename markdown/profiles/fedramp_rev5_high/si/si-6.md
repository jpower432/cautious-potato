...
x-trestle-set-params:
  ...
  si-06_odp.04:
    guidelines:
      - prose: system transitional states requiring the verification of security and
          privacy functions are defined; (if selected)
    alt-identifier: si-6_prm_3
    profile-values:
    profile-param-value-origin: <REPLACE_ME>
  si-06_odp.05:
    guidelines:
      - prose: frequency at which to verify the correct operation of security and
          privacy functions is defined; (if selected)
    alt-identifier: si-6_prm_4
    profile-values:
    profile-param-value-origin: <REPLACE_ME>
  si-06_odp.06:
    guidelines:
      - prose: personnel or roles to be alerted of failed security and privacy verification
          tests is/are defined;
