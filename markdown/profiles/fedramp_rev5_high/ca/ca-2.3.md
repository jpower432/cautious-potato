...
x-trestle-set-params:
  ...
  ca-02.03_odp.01:
    guidelines:
      - prose: external organizations from which the results of control assessments
          are leveraged are defined;
  ...
  ca-02.03_odp.03:
    guidelines:
      - prose: requirements to be met by the control assessment performed by an external
          organization on the system are defined;
