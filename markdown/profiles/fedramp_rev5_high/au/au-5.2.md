...
x-trestle-set-params:
  ...
  au-05.02_odp.01:
    guidelines:
      - prose: real-time period requiring alerts when audit failure events (defined
          in AU-05(02)_ODP[03]) occur is defined;
    alt-identifier: au-5.2_prm_1
    profile-values:
    profile-param-value-origin: <REPLACE_ME>
  au-05.02_odp.02:
    guidelines:
      - prose: personnel, roles, and/or locations to be alerted in real time when
          audit failure events (defined in AU-05(02)_ODP[03]) occur is/are defined;
    alt-identifier: au-5.2_prm_2
    profile-values:
    profile-param-value-origin: <REPLACE_ME>
  au-05.02_odp.03:
    guidelines:
      - prose: audit logging failure events requiring real-time alerts are defined;
